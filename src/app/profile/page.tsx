...
function ProfileContent() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-agri-green to-sky-teal text-white py-12 dark:from-agri-green/80 dark:to-sky-teal/80">
                  ...
                  <div className="space-y-4">
                     <div>
                       ...
                       {isEditing ? (
                         ...
                         <p className="text-foreground mt-1">{profileData.personal.name}</p>
                       )}
                     </div>
                     ...
                     <div>
                       ...
                       {isEditing ? (
                         ...
                         <p className="text-foreground mt-1">{profileData.personal.email}</p>
                       )}
                     </div>
                     ...
                     <div>
                       ...
                       {isEditing ? (
                         ...
                         <p className="text-foreground mt-1">{profileData.personal.phone}</p>
                       )}
                     </div>
                     ...
                     <div>
                       ...
                       {isEditing ? (
                         ...
                         <div className="flex items-center space-x-2 mt-1">
                           ...
                           <span className="text-foreground">{profileData.personal.location}</span>
                         </div>
                       )}
                     </div>
                  </div>
                  ...
                  <div className="space-y-4">
                     <div>
                       ...
                       {isEditing ? (
                         ...
                         <p className="text-muted-foreground mt-1">{profileData.personal.bio}</p>
                       )}
                     </div>
                     ...
                     <div className="grid grid-cols-2 gap-4">
                       <div>
                         ...
                         <p className="text-foreground mt-1">5.2 hectares</p>
                       </div>
                       <div>
                         <Label className="text-sm font-medium text-foreground">Experience</Label>
                         <p className="text-foreground mt-1">8 years</p>
                       </div>
                     </div>
          ...
          <TabsContent value="identity" className="space-y-6">
              ...
              <CardContent className="space-y-6">
                 <div className="p-4 bg-muted/5 rounded-lg">
                   <div className="flex items-center justify-between mb-3">
                     <Label className="text-sm font-medium text-foreground">DID Identifier</Label>
                  ...
                  <div className="flex items-center space-x-3">
                     <code className="flex-1 text-sm bg-background px-3 py-2 rounded border font-mono text-foreground">
                ...
                <div>
                   <h4 className="font-semibold text-foreground mb-4">Verifiable Credentials</h4>
                     ...
                     {profileData.did.credentials.map((cred, index) => (
                       <div key={index} className="flex items-center justify-between p-4 border border-border rounded-lg">
                         <div className="flex items-center space-x-3">
                           ...
                           <div>
                             <p className="font-medium text-foreground">{cred.type}</p>
                 ...
                 <div className="flex space-x-3">
                   ...
                   <Button variant="outline" onClick={handleDIDRecovery} className="border-border">
            ...
            <Card className="shadow-level2 border-0">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-agri-green/5 border border-agri-green/20 rounded-lg">
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-8 h-8 text-agri-green" />
                     <div>
                       <p className="font-semibold text-foreground">KYC Approved</p>
                       <p className="text-sm text-muted-foreground">Enhanced verification level</p>
                     </div>
                  </div>
                ...
                <div>
                   <h4 className="font-semibold text-foreground mb-4">Verification Documents</h4>
                   <div className="space-y-3">
                       ...
                       <div key={index} className="flex items-center justify-between p-3 border border-border rounded-lg">
                         <div className="flex items-center space-x-3">
                           ...
                           <div>
                             ...
                             <p className="text-sm text-muted-foreground">Uploaded {new Date(doc.uploaded).toLocaleDateString()}</p>
                           </div>
                         </div>
                        <Badge className="bg-sky-teal/10 text-sky-teal border-sky-teal/20">
                          {doc.status}
                 ...
                 <div className="flex items-center justify-between pt-4 border-t border-border">
                   <div>
                     <p className="text-sm text-muted-foreground">Last review: {new Date(profileData.kyc.lastReview).toLocaleDateString()}</p>
                     <p className="text-sm text-muted-foreground">Next review: {new Date(profileData.kyc.nextReview).toLocaleDateString()}</p>
                   </div>
                   <Button variant="outline" onClick={handleKYCRefresh} className="border-border">
                     <RefreshCw className="w-4 h-4 mr-2" />
                     Refresh Status
                   </Button>
                 </div>
          ...
          <TabsContent value="security" className="space-y-6">
            <Card className="shadow-level2 border-0">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                   ...
                   <div className="grid md:grid-cols-2 gap-4">
                     ...
                     <div>
                       ...
                       <p className="text-foreground mt-1">{profileData.security.activeSessions} active sessions</p>
                     </div>
                  </div>
                </div>
                ...
                {/* Password Management */}
                <div className="space-y-4">
                   <h4 className="font-semibold text-foreground">Password & Recovery</h4>
                   <div className="grid md:grid-cols-2 gap-4">
                     <div>
                       <Label className="text-sm font-medium text-foreground">Last Changed</Label>
                ...
                {/* Security Alerts */}
                <div className="space-y-4">
                   <h4 className="font-semibold text-foreground">Security Alerts</h4>
                   <div className="space-y-3">
                     <div className="flex items-center justify-between">
                       <div className="flex items-center space-x-3">
                         <Mail className="w-4 h-4 text-muted-foreground" />
                         <span className="text-sm text-foreground">Login alerts</span>
                       </div>
                   ...
                   <div className="space-y-3">
                     ...
                     <div className="flex items-center justify-between">
                       <div>
                         ...
                         <p className="text-xs text-muted-foreground">Display your farm location publicly</p>
                       </div>
                     ...
                     <div className="flex items-center justify-between">
                       <div>
                         <p className="text-sm font-medium text-foreground">Show farm size</p>
                         <p className="text-xs text-muted-foreground">Display your farm size in profile</p>
                       </div>
                    ...
                    { action: 'DID credentials refreshed', timestamp: '2 weeks ago', type: 'identity' }
                     ...
                     <div key={index} className="flex items-center space-x-4 p-4 border border-border rounded-lg">
                       <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                         ...
                         {activity.type === 'profile' && <User className="w-5 h-5 text-muted-foreground" />}
                         {activity.type === 'identity' && <Key className="w-5 h-5 text-muted-foreground" />}
                       </div>
